...
const PROXY_BASE = '';
const APP_ID = '6a58d59945d4b015c290e16a';
...
export default function PublicFormKnotenbeziehungen() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Knotenbeziehungen — Formular</h1>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          <div className="space-y-2">
            <Label htmlFor="beziehungstyp">Beziehungstyp *</Label>
            <Select
              value={lookupKey(fields.beziehungstyp) ?? ''}
              onValueChange={v => setFields(f => ({ ...f, beziehungstyp: v === 'none' ? undefined : v as any }))}
            >
              <SelectTrigger id="beziehungstyp" className="max-sm:h-11"><SelectValue placeholder="" /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={e => { const n = e.target.value ? Math.max(0, Number(e.target.value)) : undefined; setFields(f => ({ ...f, konfidenz: n })); }}
            />
          </div>
          <div className="space-y-2">
