...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/knoten-erstellen', label: 'Knoten vernetzen', icon: IconNetwork, description: 'Neuen Bedeutungsknoten anlegen, verknüpfen und Ereignis protokollieren' },
  // </custom:intents>
];
